...
$rm_send_address[] = 'info@chika.chips.jp';
//$rm_send_address[] = 'kg-yt.eths@hotmail.com';
...
このメールは自動返信ですが、折り返し返信が行きますのでしばらくお待ちください。

万一、数日たっても返信がない場合、このメールに心当たりがない場合は
